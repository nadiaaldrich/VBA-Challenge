...
Volume = Volume + Cells(i, 7).Value
        ...
        Cells(Row, 12).NumberFormat = "General"
        Row = Row + 1

'Reset the open price/volume
...
Next j
    ...
    'second loop to grab min and max percent change
    For Z = 2 To YCLastRow
        ...
        ElseIf Cells(Z, 12).Value = Application.WorksheetFunction.Min(WS.Range("L2:L" & YCLastRow)) Then
